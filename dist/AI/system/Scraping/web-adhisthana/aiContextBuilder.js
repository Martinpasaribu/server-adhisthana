...
function buildAIContext() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let villaData = cacheService_1.cacheService.get(CACHE_KEY);
        if (!villaData) {
            console.log('Cache miss, performing comprehensive scraping...');
            try {
                villaData = yield (0, advancedScrapingService_1.comprehensiveScrape)();
                cacheService_1.cacheService.set(CACHE_KEY, villaData, CACHE_TTL);
            }
            catch (error) {
