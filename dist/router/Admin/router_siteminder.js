...
// semantic meaning
SiteMinderRouter.post("/set-minder", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Set-Up Price"), controller_minder_1.SetMinderController.SetUpPrice);
...
SiteMinderRouter.get("/del-transaction", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Refund Booking"), controller_minder_1.SetMinderController.DeletedTransaction);
SiteMinderRouter.get("/del-booking", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Deleted Booking"), controller_minder_1.SetMinderController.DeletedBooking);
SiteMinderRouter.get("/set-price-weekday", VerifyAdminId_1.verifyAdmin, controller_minder_1.SetMinderController.SetPriceWeekDay);
SiteMinderRouter.get("/set-price-weekend", VerifyAdminId_1.verifyAdmin, controller_minder_1.SetMinderController.SetPriceWeekend);
