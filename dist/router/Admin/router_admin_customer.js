...
AdminCustomerRouter.put("/deleted/:UserId", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Deleted User"), controller_customer_1.AdminCustomerController.DeletedUser);
AdminCustomerRouter.put("/set-block/:id", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Block Account User"), controller_customer_1.AdminCustomerController.SetBlock);
AdminCustomerRouter.put("/set-active/:id", VerifyAdminId_1.verifyAdmin, (0, LogAdmin_1.logActivity)("Active Account User"), controller_customer_1.AdminCustomerController.SetActive);
