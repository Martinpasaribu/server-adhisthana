...
var UpdateRefundBooking_1 = require("./components/UpdateRefundBooking");
var SetMinderController = /** @class */ (function () {
    ...
    SetMinderController.DeletedTransaction = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var ShortAvailable, Transaction, Booking, id, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, models_booking_1.BookingModel.findOneAndUpdate({ orderId: id }, { isDeleted: false }, { "new": true, runValidators: true })];
                    case 5:
                        Booking = _a.sent();
                        if (!Booking) {
                            return [2 /*return*/, res.status(404).json({
                        ...
                        return [4 /*yield*/, models_booking_1.BookingModel.updateMany({ orderId: id }, { isDeleted: true })];
                    case 6:
                        _a.sent();
                        res.status(201).json({
                            requestId: uuid_1.v4(),
    ...
    SetMinderController.DeletedBooking = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var ShortAvailable, Transaction, Booking, id, error_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
    ...
    SetMinderController.UpdateTransactionDate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id_TRX, Edit_Date, SetcheckIn, SetcheckOut, checkIn, checkOut, checkin, checkout, night, DataRoom, dateMinderStart, dateMinderEnd, DataByDate, grossAmount, _b, ShortAvailable, Transaction, error_14;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        checkin = new Date(SetcheckIn);
                        checkin.setHours(0, 0, 0, 0);
                        checkout = new Date(SetcheckOut);
                        checkout.setHours(0, 0, 0, 0);
                        night = Math.max(0, (checkout.getTime() - checkin.getTime()) / (1000 * 60 * 60 * 24));
                        return [4 /*yield*/, models_booking_1.BookingModel.findOne({ orderId: id_TRX, isDeleted: false })];
                    case 1:
                        DataRoom = _c.sent();
                        if (!DataRoom || !DataRoom.room) {
                            throw new Error("Data booking tidak ditemukan");
                        }
                        dateMinderStart = moment_1["default"].utc(checkIn).format('YYYY-MM-DD');
                        dateMinderEnd = moment_1["default"].utc(checkOut).subtract(1, 'days').format('YYYY-MM-DD');
                        return [4 /*yield*/, models_SitemMinder_1.SiteMinderModel.find({
                                isDeleted: false,
                    ...
                    case 2:
                        DataByDate = _c.sent();
                        return [4 /*yield*/, UpdateRefundBooking_1.UpdateRefund(DataRoom.room, DataByDate, night, checkin)];
                    case 3:
                        grossAmount = _c.sent();
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                models_transaksi_1.TransactionModel.findOneAndUpdate({ bookingId: id_TRX, isDeleted: false }, { checkIn: checkIn, checkOut: checkOut, grossAmount: grossAmount }, { "new": true, runValidators: true }),
                                models_booking_1.BookingModel.findOneAndUpdate({ orderId: id_TRX, isDeleted: false }, { checkIn: checkIn, checkOut: checkOut, night: night, amountTotal: grossAmount }, { "new": true, runValidators: true })
                            ])];
                    case 5:
    ...
    SetMinderController.UpdateStockRooms = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, roomId, available, _id, UpdateRoomsStock, error_15;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
